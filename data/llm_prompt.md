...
### KNOWN METRIC NAMES
Use these metric names when they match the test being reported:
```
{metric_names}
```
...
### FOR BODY COMPOSITION / DEXA / INBODY REPORTS
...
extract EVERY test result line — not just abnormal ones. Include any flags (H, L, A, etc.) in the notes field.
